...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------#
    video_path      = r"C:\Users\Administrator\Desktop\二次投稿资料\test.mkv"
    video_save_path = " "
    #r"C:\Users\Administrator\Desktop\deeplab2 - test\img\13.mp4"
    video_fps       = 25.0
    #----------------------------------------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        print(str(tact_time/3)+ ' seconds, ' + str(1/(tact_time/3)) + 'FPS, @batch_size 1')
